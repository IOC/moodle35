...
// Note: make sure your config.php file contains $THEME->hidefromselector = false; 
// (or at least set to false) or else, your theme wont show up in theme selector.
...
$THEME->javascripts = array('font-awesome-package');
