...
$string['choosereadme'] = 'Boostioc és un tema fill de Boost dissenyat especialment per l\'Insitut Obert de Catalunya (IOC), seguint les pautes del sistema de disseny del centre.';
