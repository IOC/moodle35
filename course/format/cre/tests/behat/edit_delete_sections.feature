@format @format_cre
Feature: Sections can be edited and deleted in cre format
  In order to rearrange my course contents
  As a teacher
  I need to edit and Delete cre
  ...
  @javascript
  Scenario: Inline edit section name in cre format
  ...
  Scenario: Deleting the last section in cre format
  ...
  Scenario: Deleting the middle section in cre format
  ...
  @javascript
  Scenario: Adding sections in cre format
    When I follow "Add cre"
