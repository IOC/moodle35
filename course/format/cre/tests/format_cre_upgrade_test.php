...
/**
 * format_cre unit tests for upgradelib
 *
 * @package    format_cre
...
require_once($CFG->dirroot . '/course/format/cre/db/upgradelib.php');
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class format_cre_upgrade_testcase extends advanced_testcase {
    ...
    public function test_numsections_no_actions() {
        ...
        $DB->insert_record('course_format_options', ['courseid' => $course->id, 'format' => 'cre',
        ...
        format_cre_upgrade_remove_numsections();
    ...
    public function test_numsections_delete_empty() {
        ...
        $params1 = array('format' => 'cre', 'numsections' => 5, 'startdate' => 1445644800);
        $course1 = $this->getDataGenerator()->create_course($params1);
        $params2 = array('format' => 'cre', 'numsections' => 20, 'startdate' => 1445644800);
        ...
        $DB->insert_record('course_format_options', ['courseid' => $course1->id, 'format' => 'cre',
    ...
    public function test_numsections_add_empty_sections() {
        ...
        $params = array('format' => 'cre', 'numsections' => 16, 'startdate' => 1445644800);
        $course = $this->getDataGenerator()->create_course($params);
