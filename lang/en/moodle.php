...
$string['keep'] = 'Keep';
$string['keeptempdirectoriesonbackup'] = 'Keep backup temp directories'; // @PATCH IOC012
$string['keeptempdirectoriesonbackup_help'] = 'If $CFG->keeptempdirectoriesonbackup is not set to true, any restore happening would automatically delete the backup directory... causing the cache to return an unexisting directory.'; // @PATCH IOC012
